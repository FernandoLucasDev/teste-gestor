<template>
	<div id="layout-config" :class="containerClass">
		...
		<div class="layout-config-content">
			<h5 class="mt-0">Ajustar Tamanho</h5>
			...
			<h5>Estilo das Caixas de Texto</h5>
			<div class="p-formgroup-inline">
				<div class="field-radiobutton">
					...
					<label for="input_outlined">Sem preenchimento</label>
				</div>
				<div class="field-radiobutton">
			...
			<div class="p-formgroup-inline">
				<div class="field-radiobutton">
					...
					<label for="static">Visível</label>
				</div>
				<div class="field-radiobutton">
					<RadioButton id="overlay" name="layoutMode" value="overlay" v-model="d_layoutMode" @change="changeLayout($event, 'overlay')" />
					<label for="overlay">Escondido</label>
				</div>
			</div>

			<h5>Temas disponíveis</h5>
			<h6 class="mt-0">Victoria</h6>
			<div class="grid free-themes">
				<div class="col-3 text-center">
					<button class="p-link" type="button" @click="changeTheme($event, 'victoria', false)">
	...
	export default {
		...
		methods: {
			...
			changeTheme(event, theme, dark) {
				this.usuarioService.theme(theme);
